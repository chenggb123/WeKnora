export default {
  ...
  settings: {
    ...
    parser: {
      ...
      tierLabel: 'Parsing Tier (MinerU 4.0+)',
      tierFlash: 'flash — native text, fastest',
      tierBasic: 'basic — small models (OCR/formula/table)',
      tierStandard: 'standard — default quality (recommended)',
      tierAdvanced: 'advanced — highest quality, slower',
      tierHint: 'MinerU 4.0 replaces the legacy Backend setting with parsing tiers. With a 4.0 endpoint the Backend, vLLM URL and recognition options below are ignored; legacy (<=3.x) services still use them. The standard/advanced tiers require a VLM-capable (GPU) service; use flash or basic on CPU-only hosts.',
